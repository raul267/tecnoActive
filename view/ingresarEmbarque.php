...
<div class="row" style="margin-top:80px;">
  <form action="?c=Usuario&a=GuardarEmbarque" method="post">
    ...
    <label>BL</label>
    <div id="nBl" class="col-md-12"><div class="col-md-9"><input type="text" placeholder="bl"id="bl1" required  name="bl1"/> <input type="text" required placeholder="cantidad(toneladas)" id="cantidad1" name="cantidad1"/></div></div>
