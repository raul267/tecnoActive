<?php
  class Internacion
  {
    ...
    public function __CONSTRUCT()
     ...
     {
         $sql = $this->conn->prepare("SELECT * FROM internacion i right join bl b using(bl) right join embarque e using(idEmbarque) right join compra c using(idCompra) join producto p using(idProducto) where enPuerto =1");
         $sql->execute();
